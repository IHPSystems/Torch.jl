...
function atm_forward(arg1, tensors, ntensors)
    ccall((:atm_forward, :libdoeye_caml), tensor, (module_t, Ptr{tensor}, Cint), arg1, tensors, ntensors)
end
...
function atg_align_tensors(tensors_data, tensors_len)
    ccall((:atg_align_tensors, :libdoeye_caml), Ptr{tensor}, (Ptr{tensor}, Cint), tensors_data, tensors_len)
end
...
function atg_broadcast_tensors(tensors_data, tensors_len)
    ccall((:atg_broadcast_tensors, :libdoeye_caml), Ptr{tensor}, (Ptr{tensor}, Cint), tensors_data, tensors_len)
end
...
function atg_chunk(self, chunks, dim)
    ccall((:atg_chunk, :libdoeye_caml), Ptr{tensor}, (tensor, Int64, Int64), self, chunks, dim)
end
...
function atg_meshgrid(tensors_data, tensors_len)
    ccall((:atg_meshgrid, :libdoeye_caml), Ptr{tensor}, (Ptr{tensor}, Cint), tensors_data, tensors_len)
end
...
function atg_nonzero_numpy(self)
    ccall((:atg_nonzero_numpy, :libdoeye_caml), Ptr{tensor}, (tensor,), self)
end
...
function atg_split(self, split_size, dim)
    ccall((:atg_split, :libdoeye_caml), Ptr{tensor}, (tensor, Int64, Int64), self, split_size, dim)
end

function atg_split_with_sizes(self, split_sizes_data, split_sizes_len, dim)
    ccall((:atg_split_with_sizes, :libdoeye_caml), Ptr{tensor}, (tensor, Ptr{Int64}, Cint, Int64), self, split_sizes_data, split_sizes_len, dim)
end
...
function atg_unbind(self, dim)
    ccall((:atg_unbind, :libdoeye_caml), Ptr{tensor}, (tensor, Int64), self, dim)
end
...
function atg_where(condition)
    ccall((:atg_where, :libdoeye_caml), Ptr{tensor}, (tensor,), condition)
end
